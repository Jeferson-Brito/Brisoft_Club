        ...
        <div className="flex-1 min-w-0 w-full space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="bg-white rounded-xl p-3.5 shadow-xs border border-slate-200/80 space-y-2.5">
              ...
              {top3.length === 3 ? <div className="grid grid-cols-3 gap-2 pt-1">
                {/* 2º */}
                <div className="bg-slate-50/70 border border-slate-200/70 rounded-lg p-2 text-center flex flex-col items-center justify-between">
                  <div className="text-[10px] font-bold text-slate-500 mb-1">🥈 2º</div>
                  <Avatar name={top3[0].name} src={top3[0].photo} size="sm" />
                  <div className="font-bold text-slate-800 text-[11px] truncate max-w-full mt-1.5">{top3[0].name}</div>
                  <div className="text-xs font-black text-slate-800 mt-1">{top3[0].score} <span className="text-[9px] font-normal text-slate-400">pts</span></div>
                  <span className="mt-1 px-1.5 py-0.2 rounded text-[9px] font-bold bg-amber-100 text-amber-800">
                    {top3[0].badge}
                  </span>
                </div>

                {/* 1º */}
                <div className="bg-amber-50/40 border border-amber-200 rounded-lg p-2 text-center flex flex-col items-center justify-between shadow-2xs">
                  <div className="text-[10px] font-extrabold text-amber-700 mb-1 flex items-center justify-center gap-0.5">
                    <Crown size={11} className="text-amber-500" />
                    <span>1º</span>
                  </div>
                  <Avatar name={top3[1].name} src={top3[1].photo} size="md" />
                  <div className="font-bold text-slate-800 text-xs truncate max-w-full mt-1.5">{top3[1].name}</div>
                  <div className="text-sm font-black text-amber-700 mt-1">{top3[1].score} <span className="text-[9px] font-normal text-slate-400">pts</span></div>
                  <span className="mt-1 px-1.5 py-0.2 rounded text-[9px] font-bold bg-amber-100 text-amber-800">
                    {top3[1].badge}
                  </span>
                </div>
                ...
                {/* 3º */}
                <div className="bg-slate-50/70 border border-slate-200/70 rounded-lg p-2 text-center flex flex-col items-center justify-between">
                  <div className="text-[10px] font-bold text-amber-800 mb-1">🥉 3º</div>
                  <Avatar name={top3[2].name} src={top3[2].photo} size="sm" />
                  <div className="font-bold text-slate-800 text-[11px] truncate max-w-full mt-1.5">{top3[2].name}</div>
                  <div className="text-xs font-black text-slate-800 mt-1">{top3[2].score} <span className="text-[9px] font-normal text-slate-400">pts</span></div>
                  <span className="mt-1 px-1.5 py-0.2 rounded text-[9px] font-bold bg-slate-100 text-slate-700">
                    {top3[2].badge}
                  </span>
                </div>
              </div> : <div className="rounded-lg bg-slate-50 p-5 text-center text-xs text-slate-500">O pódio aparecerá quando este cliente tiver ao menos três colaboradores pontuados.</div>}
            </div>
